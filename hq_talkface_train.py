...
from models import talkface, talkface_disc_qual
import audio
...
parser = argparse.ArgumentParser(description='Code to train the talkface model WITH the visual quality discriminator')
...
if __name__ == "__main__":
    ...
    device = torch.device("cuda" if use_cuda else "cpu")
     ...
     # Model
    model = talkface().to(device)
    disc = talkface_disc_qual().to(device)
